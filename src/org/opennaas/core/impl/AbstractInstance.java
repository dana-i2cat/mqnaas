...
public abstract class AbstractInstance<T> {
	...
	/**
	 * Returns the currently pending dependencies, e.g. the missing capability
	 * classes.
	 */
	...
	/**
	 * Returns the currently resolved dependencies, e.g. the already initialized
	 * capability classes.
	 */
	...
	/**
	 * Resolves all dependencies that can be satisfied by the given
	...
	/**
	 * Collects and returns all fields in the given class, which have the @DependingOn
	 * annotation.
	 */
	protected Map<Class<? extends ICapability>, Field> getDependencies(
