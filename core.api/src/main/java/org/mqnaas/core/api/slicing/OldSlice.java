 ...
 *
 */
public class OldSlice {

	private static final Logger	log	= LoggerFactory.getLogger(OldSlice.class);
	 ...
	 */
	public OldSlice(SliceUnit[] units, int[] sizes, SliceCube... sliceCubes) {
	...
	/**
	 * Checks if the given <code>other</code> {@link OldSlice} is contained in this one. A slice is contained in another slice if the cubes defining this
	 ...
	 */
	public boolean contains(OldSlice other) {
	 ...
	 */
	public void add(OldSlice other) throws SlicingException {
	 ...
	 * @throws SlicingException
	 */
	public void cut(OldSlice other) throws SlicingException {
	...
	boolean isInOperationalState() {
		...
		OldSlice other = new OldSlice(units, sizes);
	...
	private void compareSliceDefinition(OldSlice other) {
	...
	private void executeOperation(OldSlice other, int[] lbs, int[] ubs, Operation operation) {
		int l = lbs.length;
	...
	private interface Operation {
		...
		boolean execute(OldSlice other, int[] coords);
	}
	...
	private class ContainsOperation implements Operation {
		...
		@Override
		public boolean execute(OldSlice other, int[] coords) {
			if (other.get(coords)) {
